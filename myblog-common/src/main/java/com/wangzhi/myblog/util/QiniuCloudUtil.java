...
public class QiniuCloudUtil {
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "Gc3lGj4HU4hiUUalDxZg5NA0rvQh-g45aT9ifluq";
    private static final String SECRET_KEY = "U_-FIPjlI0WxdY5YaQqZ7G7rjBqW15bwdPJpZUkQ";

    // 要上传的空间
    private static final String bucketname = "blog";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "plb3bmlqm.bkt.clouddn.com";

    private static final String style = "imageView2/0/q/75|imageslim";
